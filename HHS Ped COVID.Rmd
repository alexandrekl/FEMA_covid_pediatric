...
state_ma_ch %>% 
  filter( hospital_name %in% ne_chs & collection_date > '2020-09-30') %>%
...
```{r}
state_ma_ch %>% 
  filter( hospital_name %in% ne_chs & collection_date %in% c(as.Date('2022-01-12'), as.Date('2022-01-19'))) %>%
...
```{r, fig.height=4}
region_ma %>%
  filter(fema_region %in% c("Region 1", "Region 4", "Region 6", "Region 9") & collection_date > '2022-01-11') %>%
...
```{r}
us_ma %>%
  filter(collection_date > '2022-01-15') %>%
